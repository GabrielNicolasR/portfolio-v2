...
export const translations: Translations = {
  ...
  "hero.description": {
    en: 'Software Developer building intelligent systems with <span class="text-foreground">Python</span>, <span class="text-foreground">Generative AI</span>, <span class="text-foreground">RAG</span> and <span class="text-foreground">LangChain</span>. AI Engineering in progress.',
    pt: 'Desenvolvedor de Software construindo sistemas inteligentes com <span class="text-foreground">Python</span>, <span class="text-foreground">IA Generativa</span>, <span class="text-foreground">RAG</span> e <span class="text-foreground">LangChain</span>. Engenharia de IA em progresso.',
  },
  "hero.view_projects": { en: "View Projects", pt: "Ver Projetos" },
  "hero.available_opportunities": {
    en: "Available for AI engineering opportunities",
    pt: "Disponível para oportunidades de engenharia de IA",
  },
  "about.title": {
    en: 'Engineer crafting <span class="font-display text-primary">intelligent</span> systems.',
    pt: 'Engenheiro criando sistemas <span class="font-display text-primary">inteligentes</span>.',
  },
  "about.eyebrow": { en: "About", pt: "Sobre" },
  "about.paragraph1": {
    en: "I'm a Brazilian software developer currently working as Development Analyst I at Cadmus, where I started as an intern and was hired full-time after delivering on real production challenges.",
    pt: "Sou um desenvolvedor de software brasileiro atualmente trabalhando como Analista de Desenvolvimento I na Cadmus, onde comecei como estagiário e fui contratado integralmente após entregar desafios reais de produção.",
  },
  "about.years_building": { en: "Years building software", pt: "Anos construindo software" },
  "about.paragraph2": {
    en: "My focus is shifting toward AI Engineering — designing systems with Python, Generative AI, LangChain and RAG architectures. I study LLM applications and modern AI patterns to build software that's not only well-engineered, but genuinely intelligent.",
    pt: "Meu foco está migrando para Engenharia de IA projetando sistemas com Python, IA Generativa, LangChain e arquiteturas RAG. Estudo aplicações de LLM e padrões modernos de IA para construir software que não é apenas bem engenhado, mas genuinamente inteligente.",
  },
  "about.projects_shipped": { en: "Projects shipped", pt: "Projetos entregues" },
  "about.paragraph3": {
    en: "Before that, I worked as a freelance developer on Workana, shipping web projects and solving technical problems for clients with strong ratings. I care about clean code, quiet design, and learning every day.",
    pt: "Antes disso, trabalhei como desenvolvedor freelancer na Workana, entregando projetos web e resolvendo problemas técnicos para clientes com ótimas avaliações. Me importo com código limpo, design discreto e aprendizado diário.",
  },
  ...
  "experience.cadmus_point1": {
    en: "Started as an intern and was hired full-time after delivering measurable impact.",
    pt: "Comecei como estagiário e fui contratado integralmente após entregar impacto mensurável.",
  },
  ...
  "experience.cadmus_point4": {
    en: "Solving technical challenges across stack in a fast-moving environment.",
    pt: "Resolvendo desafios técnicos across stack em um ambiente de rápido movimento.",
  },
  ...
  "projects.github_description": {
    en: "Search GitHub users and explore repositories, recent events and profile data through a clean, fast UI.",
    pt: "Busque usuários GitHub e explore repositórios, eventos recentes e dados de perfil através de uma interface limpa e rápida.",
  },
  "projects.syntax_wear_title": { en: "Syntax Wear", pt: "Syntax Wear" },
  "projects.syntax_wear_description": {
    en: "E-commerce landing page with a modern design, focusing on performance and user experience.",
    pt: "Landing page de e-commerce com design moderno, focado em performance e experiência do usuário.",
  },
  ...
  "skills.description": {
    en: "A curated toolkit focused on shipping reliable software and intelligent AI systems.",
    pt: "Um conjunto de ferramentas focado em entregar software confiável e sistemas de IA inteligentes.",
  },
};
